...
Param(
    ...
    [string] [alias("ResourceGroupLocation")] $Location = 'West Europe',
    [string] $ResourceGroupName = 'mynodejsapp-rg',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'project-template.json',
    [string] $TemplateParametersFile = 'project-parameters.json',
